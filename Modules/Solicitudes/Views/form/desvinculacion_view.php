...
<div class="w3-container">
    <div class="container">
    <h3 style="text-align: center; margin-bottom: 20px;">Desvinculaciones</h3>
        <br/>
        <button type="button" class="btn btn-success" data-toggle="modal" data-target="#addModal">Nueva</button>
        <a href="<?php echo base_url('desvinculacion/desvinculacion_export'); ?>" class="btn btn-success">General Reporte para enviar</a>
        <div class="table-responsive sm">
            <table class="table table-striped">
                ...
                <tbody>
                <?php foreach($desvinculacion as $row):
        ...
        <form action="desvinculacion/save" method="post">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    ...
                                    <input type="date" name="fecha_entrada" class="form-control fecha_renuncia"  required /></td>
                                </div>
                                <div class="col-sm">
                                    <label>Fecha Salida:</label>
                                    <input type="date" name="fecha_salida" class="form-control fecha_renuncia"  required /></td>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm">
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    <label>Fecha:</label>
                                    <input type="date" name="fecha_entrega" class="form-control fecha_renuncia"  required /></td>
                                </div>
                                <div class="col-sm">
        ...
        <form action="desvinculacion/update" method="post">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    <label>Fecha Entrada:</label>
                                    <input type="date" name="fecha_entrada" class="form-control fecha_entrada"  required /></td>
                                </div>
                                <div class="col-sm">
                                    <label>Fecha Salida:</label>
                                    <input type="date" name="fecha_salida" class="form-control fecha_salida"  required /></td>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm">
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    <label>Fecha:</label>
                                    <input type="date" name="fecha_entrega" class="form-control fecha_entrega"  required /></td>
                                </div>
                                <div class="col-sm">
                                    <label>Puesto Desempeñado:</label>
                                    <input type="text" name="puesto" class="form-control puesto" placeholder="Auxiliar Policia Escolar" required /></td>
        ...
        <form action="desvinculacion/delete" method="post">
    ...
    <script>
        $(document).ready(function(){
            ...
            $('.btn-edit').on('click',function(){
                ...
                const fecha_entrada = $(this).data('fecha_entrada');
                const fecha_salida = $(this).data('fecha_salida');
                const telefono = $(this).data('telefono');
                const lugar = $(this).data('lugar');
                const fecha_entrega = $(this).data('fecha_entrega');
