...
<div class="w3-container">
    <div class="container">
        ...
        <a href="<?php echo base_url('Pension/export'); ?>" class="btn btn-success">General Reporte para enviar</a>
                ...
                <?php foreach($pension as $row):
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            data-centro="<?= $row->centro_educativo;?>" data-puesto="<?= $row->puesto;?>" >Editar</a>
                    ...
                    <div id="observaciones">
                        <script>
                            function funcionobs (valor) {
                                ...
                                $.ajax({
                                    url:"<?php echo base_url() ?>/Pension/buscar",
                                    type: "post",
                                    data: {id: valor},
                                    dataType: 'json',
        ...
        <form action="pension/delete" method="post">
    ...
    <script>
        $(document).ready(function(){
            ...
            $('.search').select2({
                ...
                ajax: {
                    url: '<?php echo base_url('Pension/ajaxSearch');?>',
                    dataType: 'json',
                    delay: 250,
