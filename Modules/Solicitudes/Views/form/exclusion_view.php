...
<div class="w3-container">
  <div class="container">
  <h3 style="text-align: center; margin-bottom: 20px;">Exclusion Dependientes</h3>
      <br/>
              ...
              <?php foreach($exclusion as $row):
                 if($row->status=='Rechazada'){
                  ...
                  <tr>
                      ...
                      <td>
                      <button type="Button" onClick="funcionobs(<?= $row->idexclusion;?>)" class="btn btn-sm btn-info" data-target="#obsModal">Observacion</button>
                          <a href="#" class="btn btn-info btn-sm btn-edit" data-id="<?= $row->idexclusion;?>" data-name="<?= $row->nombre;?>"
                          ...
                          data-relacion="<?= $row->relacion;?>" data-observacion="<?= $row->observacion;?>"  data-ndependiente1="<?= $row->nombre_dependiente1;?>" 
                          data-cdependiente1="<?= $row->cedula_dependiente1;?>" data-relacion1="<?= $row->relacion1;?>">Editar</a>
                          <a href="#" class="btn btn-danger btn-sm btn-delete" data-id="<?= $row->idexclusion;?>">Borrar</a>
                      </td>
                  </tr>
              <?php endforeach;?>
              </tbody>
      ...
      <form action="exclusion/save" method="post">
          <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog" role="document">
              <div class="modal-content">
              <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalLabel">Nueva Solicitud de Exclusi&oacute;n</h5>
              ...
              <div class="row">
                          ...
                          <div class="row">
                              <div class="col-sm">
                                  ...
                                  <input type="text" name="observacion" class="form-control" placeholder="texto corto sobre por que razones es solicitada la exclusion" required /></td>
                              </div>
                          </div>
              </div>
      ...
      <form action="exclusion/update" method="post">
          ...
          <div class="modal-dialog" role="document">
              ...
              <div class="row">
                          ...
                          <div class="row">
                              <div class="col-sm">
                                  <label>Observaci&oacute;n:</label>
                                  <input type="text" name="observacion" class="form-control observacion" /></td>
                              </div>
                          </div>
              </div>
              <div class="modal-footer">
                  <input type="hidden" name="idexclusion" class="idexclusion">
                  <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
      ...
      <form action="exclusion/delete" method="post">
