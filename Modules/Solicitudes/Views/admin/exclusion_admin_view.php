...
<div class="container" style="margin-top: 20px; margin-left:10%;">
        ...
        <form method="get" action="admexclusion" id="searchForm">
        ...
        <a href="<?php echo base_url('solicitud/admin/admexclusion/export'); ?>" class="btn btn-success">General Reporte para enviar</a>
        </div>
        <br />
        ...
        <tbody>
            ...
            foreach ($users as $users) {
                ...
                echo "<td>
                <a href='#' class='btn btn-info btn-sm' data-id=". $users['idexclusion'].">Aceptar</a>
                        <a href='#' class='btn btn-sm btn-success btn-edit' data-id=". $users['idexclusion'].">Aprobar</a>
                        <a href='#' class='btn btn-sm btn-warning' data-id=". $users['idexclusion'].">Devolver</a>
                        <a href='#' class='btn btn-danger btn-sm btn-delete' data-id=". $users['idexclusion'].">Rechazar</a>
                      </td>";
                echo "</tr>";
            }
            ?>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <input type="hidden" name="tipo" value='Exclusion'>
...
<script>
    $(document).ready(function(){
        ...
        $('.btn-warning').on('click',function(){
            ...
            //alert(id)
            $.ajax({
                url:'<?php echo base_url('solicitud/admin/exclusion/devolver');?>',
                type: "post",
                data: {'id': id},
                success:function(){
                    //location.reload();
        ...
        $('.btn-delete').on('click',function(){
            ...
            //alert(id)
            $.ajax({
                url:'<?php echo base_url('solicitud/admin/exclusion/rechazar');?>',
                type: "post",
                data: {'id': id},
                success:function(){
                    //location.reload();
        ...
        $('.btn-info').on('click',function(){
            ...
            //alert(id)
            $.ajax({
                url:'<?php echo base_url('solicitud/admin/exclusion/aceptar');?>',
                type: "post",
                data: {'id': id},
                success:function(){
                    location.reload();
