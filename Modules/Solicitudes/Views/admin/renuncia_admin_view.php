...
<div class="container" style="margin-top: 20px; margin-left:10%;">
        <h3 style="text-align: center; margin-bottom: 20px;">Renuncias y Abandonos Reportados</h3>
        <div class="row">
        <!-- Formulario de busqueda -->
        <form method="get" action="admrenuncia" id="searchForm">
        ...
        <a href="<?php echo base_url('solicitud/admin/admrenuncia/export'); ?>" class="btn btn-success">General Reporte para enviar</a>
        </div>
        <br />
        ...
        <tbody>
            ...
            foreach ($users as $users) {
                ...
                echo "<td>
                <a href='#' class='btn btn-info btn-sm' data-id=". $users['idrenuncia'].">Aceptar</a>
                        <a href='#' class='btn btn-sm btn-success btn-edit' data-id=". $users['idrenuncia'].">Aprobar</a>
                        <a href='#' class='btn btn-sm btn-warning' data-id=". $users['idrenuncia'].">Devolver</a>
                        <a href='#' class='btn btn-danger btn-sm btn-delete' data-id=". $users['idrenuncia'].">Rechazar</a>
                      </td>";
                echo "</tr>";
            }
            ?>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <input type="hidden" name="tipo" value="Renuncia">
    ...
    $(document).ready(function(){
        ...
        $('.btn-edit').on('click',function(){
            ...
            $.ajax({
                ...
                url:'<?php echo base_url('solicitud/admin/renuncia/aprobar');?>',
                type: "post",
                data: {valor: id},
                success:function(){
                    location.reload();
        ...
        $('.btn-warning').on('click',function(){
            ...
            //alert(id)
            $.ajax({
                url:'<?php echo base_url('solicitud/admin/renuncia/devolver');?>',
                type: "post",
                data: {'id': id},
                success:function(){
                    //location.reload();
        ...
        $('.btn-delete').on('click',function(){
            ...
            //alert(id)
            $.ajax({
                url:'<?php echo base_url('solicitud/admin/renuncia/rechazar');?>',
                type: "post",
                data: {'id': id},
                success:function(){
                    //location.reload();
        ...
        $('.btn-info').on('click',function(){
            ...
            //alert(id)
            $.ajax({
                url:'<?php echo base_url('solicitud/admin/renuncia/aceptar');?>',
                type: "post",
                data: {'id': id},
                success:function(){
                    location.reload();
