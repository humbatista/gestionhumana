...
<div class="container" style="margin-top: 20px; margin-left:10%;">
        <h3 style="text-align: center; margin-bottom: 20px;">Solicitudes de Vacaciones</h3>
        <div class="row">
        <!-- Formulario de busqueda -->
        <form method="get" action="admvacacion" id="searchForm">
        ...
        <a href="<?php echo base_url('solicitud/admin/admvacacion/export'); ?>" class="btn btn-success">General Reporte para enviar</a>
        </div>
        <br />
        ...
        <tbody>
            ...
            foreach ($users as $users) {
                ...
                echo "<td>". $users['empleado']. "</td>";
                echo "<td>". $users['cedula']. "</td>";
                echo "<td>". $users['periodo']. "</td>";
                echo "<td>". $users['fecha_inicio']. "</td>";
                echo "<td>". $users['fecha_fin']. "</td>";
    ...
    $(document).ready(function(){
        ...
        $('.btn-edit').on('click',function(){
            ...
            $.ajax({
                ...
                url:'<?php echo base_url('solicitud/admin/vacacion/aprobar');?>',
                type: "post",
                data: {valor: id},
                success:function(){
                    location.reload();
        ...
        $('.btn-warning').on('click',function(){
            ...
            //alert(id)
            $.ajax({
                url:'<?php echo base_url('solicitud/admin/vacacion/devolver');?>',
                type: "post",
                data: {'id': id},
                success:function(){
                    //location.reload();
        ...
        $('.btn-delete').on('click',function(){
            ...
            //alert(id)
            $.ajax({
                url:'<?php echo base_url('solicitud/admin/vacacion/rechazar');?>',
                type: "post",
                data: {'id': id},
                success:function(){
                    //location.reload();
        ...
        $('.btn-info').on('click',function(){
            ...
            //alert(id)
            $.ajax({
                url:'<?php echo base_url('solicitud/admin/vacacion/aceptar');?>',
                type: "post",
                data: {'id': id},
                success:function(){
                    location.reload();
