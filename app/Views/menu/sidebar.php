                            ...
                            <ul class="sidebar-menu metismenu" id="sidebar-menu">
                                ...
                                <li>
                                    ...
                                    <ul class="sidebar-nav">
                                        <li><a href="#"><i class="fa fa-ellipsis-h"></i>Listar productos</a></li>
                                ...
                                <li>
                                    <a href="">
                                        <i class="fa fa-book"></i>Proveedor
                                        <i class="fa arrow"></i>
                                    </a>
                                    <ul class="sidebar-nav">
           <li><a href="#"><i class="fa fa-ellipsis-h"></i>Listar proveedores</a></li>                            
...
<li><a href="#"><i class="fa fa-plus"></i>Añadir pedido</a></li>
           ...
           <li><a href="#"><i class="fa fa-ellipsis-h"></i>Listar clientes</a></li>                            
            ...
            <li><a href="#"><i class="fa fa-gear"></i>Configuracion general</a></li>
                                ...
                                <li>
                                    ...
                                    <!--
                                <li>
                                    <a href="{% static 'inventario/manual.pdf' %}" download>
                                        <i class="fa fa-download"></i> Descargar manual de usuario (PDF)
